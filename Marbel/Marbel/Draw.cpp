...
void Menu() {
	...
	gotoxytext(55, 28, "[1] °ÔÀÓ¹æ »ý¼º");
	gotoxytext(55, 30, "[2] °ÔÀÓ¹æ ÀÔÀå");
	gotoxytext(55, 32, "[3] °ÔÀÓ ¼³¸í");
...
void Explain() {
	...
	gotoxy(25, 7); printf("µÚ·Î°¡±â´Â Enter¸¦ ´­·¯ÁÖ¼¼¿ä!");
	...
	gotoxy(25, 39); printf("### ¹æÀåÀº ¹Ýµå½Ã 10201¹ø Æ÷Æ®¸¦ Æ÷Æ®Æ÷¿öµùÇÏ¼¼¿ä!");
	gotoxy(25, 40); printf("### Æ÷Æ®Æ÷¿öµùÀ» ÇÏÁö¾ÊÀ¸¸é ´Ù¸¥ ÇÃ·¹ÀÌ¾îµéÀÌ Á¢¼ÓÇÏÁö ¸øÇÕ´Ï´Ù.");
	getch();
	system("cls");
}
